...
- 学年预览、二次确认、幂等批量升级与审计。
- 文本知识库切分、AI 会话持久化、每日额度、SSE 流式输出、来源引用和关键词降级检索。
- 举报后台筛选、忽略、隐藏与删除联动；问题置顶、锁定、隐藏；关键管理操作写入审计日志。
...
- 举报后台的封禁/警告联动，标签/公告的增删改 UI，个人资料/头像/邮箱换绑、退出其他设备、账号软注销。
- 问题关注（区别于收藏）、通知逐条删除、AI 对话改名/删除/重新生成/反馈、引用片段精确排名。
